 ...
 */
define(['vue',
  'text!components/dropfilter/index.html',
  'css!components/dropfilter/css/dropfilter.css'
  ...
  return Vue.extend({
    ...
    created: function () {
      ...
      this.filterTarget = $.extend(true, [], this.filtersData);
    },
    mounted: function () {
      var self = this;
      ...
      $('#' + self.dropId).on('shown.bs.dropdown', function () {
        $('.filter-container .dropdown-list ul').perfectScrollbar('update');
      })
      this.$nextTick(function () {
        this.setInitValue();
        $('.filter-container .dropdown-list ul').perfectScrollbar();
      });
      this.setInitValue();
    },
    watch: {
      ...
      filtersData: function (nVal) {
        this.filterTarget = $.extend(true, [], nVal);
      },
